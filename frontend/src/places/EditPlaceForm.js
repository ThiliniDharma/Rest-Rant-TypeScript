...
function EditPlaceForm() {
    ...
    function handleSubmit(e) {
        return __awaiter(this, void 0, void 0, function* () {
            e.preventDefault();
            yield fetch(`http://localhost:5000/places/$place.placeId:any`, {
                method: 'PUT',
                headers: {
            ...
            history.push(`/places/$place.placeId:any`);
        });
    }
    return (react_1.default.createElement("main", null,
        react_1.default.createElement("h1", null, "Edit Place"),
        react_1.default.createElement("form", { onSubmit: handleSubmit },
            ...
            react_1.default.createElement("input", { className: "btn btn-primary", type: "submit", value: "Save" }))));
}
exports.default = EditPlaceForm;
